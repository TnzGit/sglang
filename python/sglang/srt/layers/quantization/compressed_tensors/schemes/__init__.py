...
from .compressed_tensors_w4a4_nvfp4_marlin import CompressedTensorsW4A4Fp4Marlin
...
from .compressed_tensors_w8a8_fp8_marlin import CompressedTensorsW8A8Fp8Marlin
