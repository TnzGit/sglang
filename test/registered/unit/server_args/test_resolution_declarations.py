...
class TestResolutionDeclarations(CustomTestCase):
    ...
    def test_a_platform_plugin_default_reaches_the_projection(self):
        ...
        # Subclass the live platform rather than hand-rolling a stand-in: the
        # pipeline asks it other questions on the way through (whether it is
        # out of tree, whether it supports piecewise capture), and which of
        # those it reaches depends on the host.
